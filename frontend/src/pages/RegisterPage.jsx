...
export default function RegisterPage() {
  ...
  return (
    <section className="mx-auto mt-10 w-full max-w-md rounded-2xl border border-white/10 bg-[#16324f] p-6 shadow-xl">
      <h1 className="mb-1 text-3xl font-black text-[#f7f4ea]">Create Account</h1>
      <p className="mb-6 text-sm text-slate-300">Join and help keep the city clean.</p>
      ...
      <p className="mt-4 text-sm text-slate-300">
        ...
        <Link to="/login" className="font-bold text-[#f7f4ea] underline">
          Login
        </Link>
      </p>
    </section>
